...
import 'package:flutter_grocery/view/screens/prescription/prescription.dart';
...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static void setupRouter() {
    ...
    router.define(prescription,
        handler: _prescriptionHandler, transitionType: TransitionType.fadeIn);
