...
class CartModel {
  ...
  CartModel(this._id, this._image, this._name, this._price, this._prescriptionRequired, this._discountedPrice, this._quantity, this._variation, this._discount,
  ...
  CartModel.fromJson(Map<String, dynamic> json) {
    ...
    _image = json['image'];
    _price = json['price'];
    _prescriptionRequired = json['prescription_required'];
    ...
    _unit = json['unit'];
    _stock = json['stock'];
    _prescriptionImage = json['prescriptionImage'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['prescription_required'] = this._prescriptionRequired;
    ...
    data['prescriptionImage'] = this._prescriptionImage;
    return data;
  }
}
