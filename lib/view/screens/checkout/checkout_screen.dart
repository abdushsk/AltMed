                                      ...
                                      child: CustomButton(
                                        ...
                                        onPressed: () async {
                                          if (!_selfPickup &&
                                            ...
                                            String pickedPdf;
                                            for (var i in images) {
                                              Uint8List imagebytes = await i
                                                  .readAsBytes(); //convert to bytes
                                              pickedImages.add(
                                                  cv.base64.encode(imagebytes));
                                            }
                                            if (pdf != null) {
                                              Uint8List imagebytes = await pdf
                                                  .readAsBytes(); //convert to bytes
                                              pickedPdf =
                                                  cv.base64.encode(imagebytes);
                                            }
